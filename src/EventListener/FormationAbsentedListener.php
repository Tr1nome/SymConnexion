...
class FormationAbsentedListener implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        return [
            "formation.absented" => [
                ["onFormationAbsented", 0],
                ["writeLog", -10],
            ]
        ];
    }

    public function onFormationAbsented(FormationAbsentedEvent $event):void
    {
        ...
        $message = (new Swift_Message($user->getEmail()))
            ...
            ->setBody(
                $this->templating->render(
                    'emails/formation_absented.email.twig',
